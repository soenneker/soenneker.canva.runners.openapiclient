...
using Soenneker.Canva.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Canva.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Canva:ClientGenerationUrl"] ?? "https://www.canva.dev/sources/connect/api/latest/api.yml";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Canva OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "CanvaOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
